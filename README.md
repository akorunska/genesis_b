...
This is simple prototype of a  bitcoin node, implemented with python -- pitcoin.
...
/chain/block?hash=<hash>                                # get block at certain height
...
/produce-block                                          # produce block with 1 transaction from mempool
```
